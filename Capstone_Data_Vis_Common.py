...
# function to plot bar graph for different classes of a given dataset class column
def plot_class_counts(data,x_label,y_label,title):
    data.value_counts().plot(kind='bar',rot=0,width=0.3);
